...
<div class="grid">
	...
	<div class="grid-item all-departments">
		<ul>
	...
	<a class="grid-item date" data-open="directions"><img src="<?php echo get_template_directory_uri() ?>/assets/images/tiles/Dates_<?php $random = rand(1,6); echo $random; ?>.svg" alt="Dates" /></a>
	<a class="grid-item date" data-open="directions"><img src="<?php echo get_template_directory_uri() ?>/assets/images/tiles/Dates_<?php $random = rand(1,6); echo $random; ?>.svg" alt="Dates" /></a>
	<a class="grid-item date" data-open="directions"><img src="<?php echo get_template_directory_uri() ?>/assets/images/tiles/Dates_<?php $random = rand(1,6); echo $random; ?>.svg" alt="Dates" /></a>
	<a class="grid-item date" data-open="directions"><img src="<?php echo get_template_directory_uri() ?>/assets/images/tiles/Dates_<?php $random = rand(1,6); echo $random; ?>.svg" alt="Dates" /></a>
	<a class="grid-item date" data-open="directions"><img src="<?php echo get_template_directory_uri() ?>/assets/images/tiles/Dates_<?php $random = rand(1,6); echo $random; ?>.svg" alt="Dates" /></a>
