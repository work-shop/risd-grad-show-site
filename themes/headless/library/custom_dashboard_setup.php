...
class rc_sweet_custom_dashboard {
	...
	function rc_scd_redirect_dashboard() {
		...
		if( is_admin() ) {
			...
			if( $screen->base == 'dashboard' ) {
				...
				wp_redirect( admin_url( 'index.php?page=cms-home' ) );
	...
	function rc_scd_register_menu() {
		add_dashboard_page( 'Content Management Home', 'Content Management Home', 'read', 'cms-home', array( &$this,'rc_scd_create_dashboard') );
	}
